                    ...
                    <div className="card shadow-sm bg-opac text-white border-0">
                        ...
                        <div className="card bg-opac text-white border-0">
                            <div className="card-body">
                                <div className="row">
                                    <div className="col-12">
                                        <h1 className="display-4">100.00</h1>
                                    </div>
                                    <div className="col-auto">
                                        <p className="text-muted">Wallet Balance</p>
                                    </div>
                                    <div className="col text-end">
                                        <p className="text-muted"><a href="addmoney.html">+ Top up</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <ul className="nav nav-pills">
                        <li className="nav-item">
                            <a className="nav-link active" aria-current="page" href="index.html">
                                <div className="avatar avatar-40 rounded icon"><i className="bi bi-house-door"></i></div>
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li><a className="dropdown-item nav-link" href="profile.html">
                                        <div className="avatar avatar-40 rounded icon"><i className="bi bi-calendar2"></i></div>
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="chat.html" tabIndex="-1">
                                <div className="avatar avatar-40 rounded icon"><i className="bi bi-chat-text"></i></div>
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="notifications.html" tabIndex="-1">
                                <div className="avatar avatar-40 rounded icon"><i className="bi bi-bell"></i></div>
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="blog.html" tabIndex="-1">
                                <div className="avatar avatar-40 rounded icon"><i className="bi bi-newspaper"></i></div>
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="style.html" tabIndex="-1">
                                <div className="avatar avatar-40 rounded icon"><i className="bi bi-palette"></i></div>
                                <div className="col">Style <i className="bi bi-star-fill text-warning small"></i></div>
                                <div className="arrow"><i className="bi bi-chevron-right"></i></div>
                            </a>
                        </li>

                        <li className="nav-item">
                            <a className="nav-link" href="pages.html" tabIndex="-1">
                                <div className="avatar avatar-40 rounded icon"><i className="bi bi-file-earmark-text"></i></div>
                                <div className="col">Pages <span className="badge bg-info fw-light">new</span></div>
                                <div className="arrow"><i className="bi bi-chevron-right"></i></div>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="signin.html" tabIndex="-1">
                                <div className="avatar avatar-40 rounded icon"><i className="bi bi-box-arrow-right"></i></div>
